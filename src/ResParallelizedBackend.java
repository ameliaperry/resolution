...
class ResParallelizedBackend implements ResBackend
{
...
class ResTask implements Comparable<ResTask>
{
    ...
    @Override public int compareTo(ResTask o)
    {
        return t - o.t;
    }
}

class ResTaskThread extends Thread
{
    ResParallelizedBackend back;
    int id;
    volatile static int ids;
    ResTaskThread(ResParallelizedBackend back) {
